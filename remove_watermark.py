...
def remove_watermark_core(img_array, threshold=None, enable_multi_algorithm=True):
    ...
    if enable_multi_algorithm and quality is not None and watermark_template is not None:
        ...
        # FORCE SEGMENTED ONLY - NO OTHER ALGORITHMS
        # User verified that segmented samples correctly while exemplar picks wrong colors
        algorithms_to_try = []
        print("Strategy: FORCING SEGMENTED ONLY (no alternatives)")
